...
//include 'time.php';
session_start();
$ques =isset($_POST['qid'])?mysql_real_escape_string($_POST['qid']):"";
$user=$_SESSION['user_id'];
$ch=mysql_query("SELECT answer From Submissions where qid = '$ques' AND user_id='$user' ");
$ch1=mysql_fetch_array($ch);
$sql=mysql_query("SELECT * From Questions where qid = '$ques' ");
if(!$sql){
     echo mysql_error();
}
...
<br>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8" id="col-sm-8" align="left"  > <?php echo $ch1[answer]; ?>
    <br><br><br><br>
...
<font color="black">
 <input type="text" name="input" id="inpt"  style="position:relative;top:420px;right:800px;background-color: #e4e4e4;;" color:"black"; placeholder="INPUT" ></font>
...
<option value="CPP"><b>C++</option></b></option>
...
<button type="submit" formtarget="_blank" value="submit" style=" position:relative;top:50px;left:90px;
    ...
    <button type="submit" formaction="resubmit.php" value="submit" style=" position:relative;top:50px;left:90px;
    background-image: linear-gradient(to bottom, #84cfcc, #29a9b3);
    border-color:#96c5be;;
    border-bottom-color: #6db2d3;">Submit Code</button>
